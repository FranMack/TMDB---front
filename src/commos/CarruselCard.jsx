...
function CarruselCard({ movie, handleNumLeft, handleNumRight }) {
  ...
  return (
    <>
    {movie && movie.backdrop_path && <div className={`${changingImage ? "changingImage" : "carruselCard"}`}>
        <ArrowBackIosNewIcon
          fontSize="large"
          sx={{ position: "absolute", left: "5%", bottom:"10%", fontSize:"3rem","&:hover": {color:"#f7a102"} }}
          onClick={()=>{handleImageChange();handleNumLeft()}}
        />
        <img
          className="cardImage"
        ...
        <ArrowForwardIosIcon
          fontSize="large"
          sx={{ position: "absolute", right: "5%",bottom:"10%",fontSize:"3rem","&:hover": {color:"#f7a102"}, }}
          onClick={()=>{handleImageChange(),handleNumRight()}}
        />
        ...
        <div className="carruselInfo">
          ...
          <Button variant="contained" sx={{marginTop:"5%", backgroundColor:"#ea0505"}}>Mas info</Button>
          </Link>
